...
a persistence unit "energiaElectricaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "energiaElectrica/pom.xml":
...
artifact ("energiaElectrica.war") is already built. You can build
